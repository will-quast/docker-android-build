...
# Update Android sdk
RUN ./scripts/accept-licenses "android update sdk --no-ui --all --filter build-tools-25.0.0,build-tools-25.0.1,build-tools-25.0.2,build-tools-25.0.3,android-24,android-25,extra-google-google_play_services,extra-google-m2repository,extra-google-play_billing,extra-intel-Hardware_Accelerated_Execution_Manager,sys-img-x86_64-google_apis-25" "android-sdk-preview-license-d099d938|android-sdk-license-c81a61d9"
